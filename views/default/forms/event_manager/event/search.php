...
$form_body = elgg_view('output/url', [
    ...
    'rel' => 'toggle',
    'data-toggle-selector' => '#event-manager-search-form-past-events, #event_manager_event_search_advanced_container, #event_manager_event_search_advanced_enable span span',
